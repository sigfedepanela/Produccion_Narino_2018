...
var style_ProduccindePanelaToneladas_2 = function(feature, resolution){
    ...
    if (value >= 19.320000 && value <= 809.780000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 809.780000 && value <= 2697.610000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2697.610000 && value <= 4820.060000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4820.060000 && value <= 16668.140000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 16668.140000 && value <= 24336.280000) {
            style = [ new ol.style.Style({
